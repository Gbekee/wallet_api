...
urlpatterns=[
    ...
    path('api/transaction/<int:pk>', views.TransactionDetailViewSet.as_view(), name='users'),
    path('api/wallets', views.WalletsViewSet.as_view(), name='users'),
    path('api/wallet/<int:pk>', views.WalletDetailViewSet.as_view(), name='users'),
    path('api/beneficiaries', views.BeneficiariesViewSet.as_view(), name='users'),
    path('api/beneficiary/<int:pk>', views.BeneficiaryDetailViewSet.as_view(), name='users')
]